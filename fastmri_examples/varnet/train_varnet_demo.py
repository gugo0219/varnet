...
def build_args():
    ...
    default_root_dir = fetch_dir("log_path", path_config) / "varnet"
    ...
    parser.set_defaults(
        ...
        pools=1,  # number of pooling layers for U-Net
        chans=18,  # number of top-level channels for U-Net
        sens_pools=1,  # number of pooling layers for sense est. U-Net
    ...
    args.callbacks = pl.callbacks.ModelCheckpoint(
